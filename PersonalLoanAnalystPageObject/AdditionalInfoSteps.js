class PersoanlAdditionalinformation {
  constructor(page) {
    this.page = page;
    ...
    this.AdditionalInsightsNeeded = page.locator(
      '[data-testid="Additional Insights Needed:text-area:control"]'
    );
    this.ConformButton = page.locator(
      "xpath=/html/body/app-root/div/div[1]/div/main/div/div/div[2]/div[1]/div[2]/div/article/div/li/article/div/form/div[1]/div/div/fieldset/div/div/div/div[14]/fieldset/div/div/div/div[1]/div[7]/fieldset/div[1]/div/label/div"
    );
  ...
  async Approve(feedback, Decision, info) {
    ...
    await this.AdditionalInsightsNeeded.fill(info);
...
module.exports = { PersoanlAdditionalinformation };
